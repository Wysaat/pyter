enum types { identifier_t, int_expr_t, float_expr_t, imag_expr_t, str_expr_t,
             ...
             slice_expr_t, subsc_expr_t, slicing_t, subscription_t, call_t,
             power_t, u_expr_t, b_expr_t, comparison_t,
             not_test_t, conditional_expression_t,
             expression_list_t,
             expression_stmt_t, assignment_stmt_t, return_stmt_t,
             stmt_list_t,
             if_stmt_t, while_stmt_t, for_stmt_t, funcdef_t, suite_t,
